...
const s2 = new Segment(new Vector(4, 16), new Vector(8, 16), 50, [0, [3, 13], 9], true, canvas); // Mid left to more left
const s3 = new Segment(new Vector(10, 16), new Vector(16, 16), 50, [0, [9], 8], true, canvas); // More left to center

const s4 = new Segment(new Vector(6, 2), new Vector(16, 2), 50, [3, [5]], true, canvas); // Top left to top mid
const s5 = new Segment(new Vector(16, 4), new Vector(16, 6), 50, [0, [6, 7], 7], true, canvas); // Top mid to two down
const s6 = new Segment(new Vector(16, 8), new Vector(16, 16), 50, [6, [9], 8], true, canvas); // Top mid to center
...
const s15 = new Segment(new Vector(8, 28), new Vector(8, 18), 50, [6, [13, 3], 9], true, canvas); // Bottom left to mid left
