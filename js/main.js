...
var seg1 = new Segment(new Vector(1, 1), new Vector(1, 6), 50, 3, [[2, 1]], canvas);
var seg2 = new Segment(new Vector(3, 6), new Vector(6, 6), 50, 2, [], canvas);
var seg3 = new Segment(new Vector(6, 8), new Vector(3, 8), 50, 4, [], canvas);
